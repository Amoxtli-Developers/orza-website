  ...
  const handleSubmit = async (e) => {
    ...
    const emailBody = `
      <div style="text-align: center;">
        ...
        <h3>New partner contact from ${name}</h3>
        <p>Email: ${email}</p>
        <p>Phone: ${phone}</p>
    ...
    try {
      const result = await Email.send({
        ...
        To: "partnerships@orzatech.com ",
        From: "amoxtlidev@gmail.com",
        Subject: "Contact from ORZA Tech Parnership Form",
        Body: emailBody,
      });
      console.log(result);
      ...
      <Grid container spacing={4} alignItems="center" justifyContent="center">
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" sx={{ mb: 4 }}>
            Collaborate with us and amplify your business. Partnering with ORZA
            Tech means joining a network committed to technological excellence
            and mutual growth.
          </Typography>
          <TextField
            name="name"
...
export default OrzaPartnerForm;
